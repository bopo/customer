...
class ItemUpdateRequest(RestApi):
    ...
    def getTranslateParas(self):
        return {'food_security_stock_date_start': 'food_security.stock_date_start',
            ...
            'ms_payment_reference_price': 'ms_payment.reference_price', 'paimai_info_reserve': 'paimai_info.reserve',
            'food_security_factory': 'food_security.factory',
            ...
            'paimai_info_valid_minute': 'paimai_info.valid_minute', 'locality_life_merchant': 'locality_life.merchant',
            ...
            'locality_life_network_id': 'locality_life.network_id', 'food_security_supplier': 'food_security.supplier',
