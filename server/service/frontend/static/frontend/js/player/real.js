function $Showhtml(){
	player = '<object id="realObj" classid="clsid:CFCDAA03-8BE4-11cf-B84B-0020AFBBCCFA" width="100%" height="'+(Players.Height-60)+'">';
	player += '<param name="CONTROLS" value="ImageWindow">';
	player += '<param name="CONSOLE" value="Clip1">';
	player += '<param name="AUTOSTART" value="-1">';
	player += '<param name="src" value="'+Players.Url+'"></object><br>';
